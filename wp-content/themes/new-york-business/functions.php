...
if ( isset( $_GET['new_york_business_notice_dismissed'] ) ){
	update_option('new_york_business_help_notice', 'do-not-show');
}
...
if(!function_exists('new_york_business_general_admin_notice')){
	...
	function new_york_business_general_admin_notice(){
			 $msg = sprintf('<div data-dismissible="disable-done-notice-forever" class="notice notice-info is-dismissible" ><p>
					...
					esc_html__('Upgrade to PRO','new-york-business'),
					esc_url(new_york_business_THEME_DOC),	
					esc_html__('See tutorials','new-york-business'),
					esc_html__(' Install Elementor and use widgets starting prefix Theme:  See Appearance - Customize - Themes Options for customization.', 'new-york-business'),
...
if($new_york_business_help_notice != 'do-not-show' || $new_york_business_help_notice != ''){
